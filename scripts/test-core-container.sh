...
docker exec -e CTLVPS_SYSTEMD_TEST=1 "$container" /core.test -test.run 'TestSharedServiceLifecycle|TestSingBoxConfigPassesCheck|TestSnellMeterSurvivesRestart' -test.v
